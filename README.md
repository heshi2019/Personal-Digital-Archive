...
|               平台                | 功能           | 最后更新   | 开发状态 | 备注                          |
| :-------------------------------: | -------------- | ---------- | :------: | ----------------------------- |
|             微信读书              | 书籍笔记与划线 | 2025-04-01 | ✅ 已完成 | -                             |
|               豆瓣                | 已标记电影     | 2025-04-06 | ✅ 已完成 | -                             |
|               机核                | 电台信息       | 2025-04-08 | ✅ 已完成 | -                             |
|               flomo               | 笔记和图片     | 2025-04-21 | ✅ 已完成 | -                             |
|               钱迹                | 记账信息       | 2025-05-03 | ✅ 已完成 | -                             |
| [missAV](https://missav.ai/dm265) | 收藏视频       | 2026-05-11 | ✅ 已完成 | -                             |
...
钱迹个人数据采集脚本的详细说明见：[readme-qianji.md](readme-qianji.md)。

# WeRead collector

微信读书个人数据采集脚本的详细说明见：[readme-weread.md](readme-weread.md)。
...
在页面展示方面首先确定页面逻辑，再决定页面样式，首先要确定前端页面的功能，再决定页面长什么样。
