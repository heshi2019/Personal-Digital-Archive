...
class WeReadApi:
    ...
    def get_cookie(self):
        ...
        cookie = config.get_key("WEREAD", "cookie")
        if cookie is None:
    ...
    def get_notebooklist(self):
        ...
        if r.ok:
            ...
            config.save("Data_Star", "Weread_get_notebooklist.json", r.json(), "txt")
    ...
    def get_chapter_info(self, bookId):
        ...
        if (
            ...
            config.save("Data_Star", "Weread_get_chapter_info.json",
    ...
    def get_bookmark_list(self, bookId):
        ...
        if r.ok:
            ...
            config.save("Data_Star", "Weread_bookmark.json", r.json(), "txt")
